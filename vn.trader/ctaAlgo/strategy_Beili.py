...
class Strategy_BeiLi(CtaTemplate):
    """螺纹钢、15分钟级别，背离策略
    策略：
    仓位管理：
    1h级别上的macd死叉和金叉决定仓位
    ...
    def onBarM15(self, bar):
        ...
        if self.pos == 0:
            # DIF快线上穿DEA慢线，金叉
            # 如果要macd大于2的代码abs(self.lineM15.lineMacd[0 - idx]) > 2
...
def testRbByBar():
    ...
    # 开始跑回测
    engine.runBackTestingWithBarFile(os.getcwd() + '/cache/RB88_20100101_20170605_15m.csv')
